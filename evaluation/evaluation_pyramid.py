...
from transformers import BertTokenizer, AutoModelForSequenceClassification, RobertaTokenizer, AlbertTokenizer, AlbertForSequenceClassification, DebertaForSequenceClassification, DebertaTokenizer
from models.support_model.Roberta import ContrastiveRoberta
from models.support_model.Roberta import SupportScoreModel

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

tokenizer1 = BertTokenizer.from_pretrained('bert-base-uncased')
model_path1 = 'models/relevance_model/'
...
model_path2 = 'models/support_model/best_model.pt'
...
tokenizer3 = AlbertTokenizer.from_pretrained('models/coherence_model/')
model3 = AlbertForSequenceClassification.from_pretrained('models/coherence_model/')
model3 = model3.to(device)
model3.eval()

# Load Model 4: Deberta for completeness
tokenizer4 = DebertaTokenizer.from_pretrained('models/completeness_model/')
model4 = DebertaForSequenceClassification.from_pretrained('models/completeness_model')
...
def calculate(argument_pyramid):
    ...
    completeness_score_1 = calculate_completeness(claim, arguments, tokenizer4, model4)
